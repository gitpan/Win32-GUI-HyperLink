# check the dependancies and report likely missing functionality
...
if (ok($Win32::GUI::VERSION, "Win32::GUI v1.0 or higher" )) {
  ...
  # Note the format of the 'Bail out!' tetx is vital to Test::Harness
  # spotting this.
...
SKIP: {
    ...
    pass("Win32::GUI::BitmapInline v0.02 or higher") and
      diag("Win32::GUI::BilmapInline version $Win32::API::VERSION found");
}
